...
\textbf{Abstract:}\\
The social networks are the most common source of the news and the informations nowadays. But their content is affected by \textit{preferetial algorithms}, which filters informations and leads user to bubble with homogenous opinions. This phenomenon is called \textit{filter bubble} and can cause creation of radical groups.\\
\forceindent We present new way to study filter bubble in online communities. Unlike most of the related work our approach allows researche precisely on the cosial networks. \textit{Sentimental analysis} is used to perform measurements of the content viewed by the \textit{Twitteru} users.\\
\forceindent We present power of our method on a several examples and show ability of providing sociological results.\\
