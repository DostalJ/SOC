...
\begin{frame}
    ...
    % \column{\dimexpr\paperwidth-20pt}
        \center
        \includegraphics[scale=0.4]{./Pics/filterbubble.png}\\
    % \end{columns}
\end{frame}
% ############################################
% ############################################
...
%     \begin{block}{Biochemical Society:}
%         \begin{itemize}
%             \item \begin{footnotesize} \uv{\textit{Trump's travel expenses in 10 weeks cost U.S. taxpayers as much as Obama spent in 2 years, @Independent estimates}}\end{footnotesize} (0.2855)
%         \end{itemize}
%     \end{block}
