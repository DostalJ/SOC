...
\begin{frame}{Filter bubble}
    ...
    \begin{block}{Goals:}
        \begin{itemize}
            ...
            \item filter bubble \textbf{detection}
        \end{itemize}
    \end{block}
    \end{columns}
\end{frame}
...
\begin{frame}{Method}
    \begin{enumerate}
        ...
        \vspace{0.25cm}
        \onslide<0>\item content affecting the studied people
        \vspace{0.25cm}
...
\begin{frame}{Method}
    \begin{enumerate}
        ...
        \vspace{0.25cm}
        \onslide<1>\item\bfseries content affecting the studied people
        \vspace{0.25cm}
        \onslide<0>\item posts on given topic
        \vspace{0.25cm}
        \onslide<0>\item sentimental analysis
...
\begin{frame}{Tweets collection}
    ...
    \column{5cm}
    	\begin{itemize}
            \item content affecting the studied people
    		\item content from \textbf{followed people}
    		\item mutual tweets
    	\end{itemize}
    \column{6cm}
    	\center
    	\includegraphics[scale=0.41]{./Pics/followers.png}
    \end{columns}
\end{frame}
% ############################################
% ############################################
\begin{frame}{Method}
    \begin{enumerate}
        ...
        \onslide<1>\item studied groups selection
        \vspace{0.25cm}
        \onslide<1>\item content affecting the studied people
        \vspace{0.25cm}
