...
class Vocabulary:
    ...
    Parameters:
        pos_file_path: path to file with positive samples
        neg_file_path: path to file with negative samples
        vocabulary_file: optional path to vocabulary
        vocabulary_size: number of words to save to vocabulary
    Methods:
    ...
    def prepare_data_and_labels(self, pos_data=None, neg_data=None, vocabulary_size=None):
        """
        Loads the data from files, translates to nums (by making vocabulary) and
        transforms it to trainable format
